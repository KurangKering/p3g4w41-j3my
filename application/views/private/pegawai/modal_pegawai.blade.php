          ...
          <div id="edit" class="tab-pane">
            <div class="row">
              <div class="col-md-5" style="border-right: 1px solid #ddd;">
                ...
                <button type="button" class="btn-berkas mb-xs mt-xs mr-xs btn btn-default btn-block">{{ $dokumen['caption'] }}</button>
...
<script>
  ...
  var set_modal_data = function(data)
  {
    ...
    $.each(arrayBerkas, function(index, val) {
      ...
      $currentBtn.click(function(event) {
        $("#berkas-photo").attr('src', '{{ site_url('media/') }}'+data.data_dokumen[index]);
        $(".btn-berkas").removeClass('btn-primary');
  ...
  function print_pegawai(id)
  {
    ...
    window.open('{{ site_url('private/pegawai/print/') }}'+id);
  }
</script>
@endsection