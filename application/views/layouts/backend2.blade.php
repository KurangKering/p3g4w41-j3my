...
<head>
  ...
  {{-- <link href="{{ site_url('assets/templates/backend2/plugins/bootstrap-select/css/bootstrap-select.css') }}" rel="stylesheet" /> --}}
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          <!-- Call Search -->
          <li><a href="{{ site_url('auth/do_logout')  }}" >Logout</a></li>
          <!-- #END# Call Search -->
        </ul>
      </div>
    </div>
    ...
    <aside id="leftsidebar" class="sidebar">
      ...
      <div class="menu">
        <ul class="list">
         ...
         <li class="{{ hActiveMenu('private') }}">
          <a href="{{ site_url('private') }}">
