     ...
     <form class="form-horizontal" action="" id="frm-create-lembar-disposisi" method="post" enctype="multipart/form-data">
      ...
      <div class="card-body">
       ...
       <div class="form-group row">
        <label class="col-md-4 col-form-label" for="nama">Isi Disposisi</label>
        <div class="col-md-8 col-form-label">
          ...
          <div class="form-check">
            <input class="form-check-input" required id="isi_disposisi_<?php echo e($val); ?>" type="radio" value="<?php echo e($val); ?>" name="isi_disposisi">
            <label class="form-check-label" for="isi_disposisi_<?php echo e($val); ?>"><?php echo e($isi); ?></label>
          </div>
