...
<body class="theme-red">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                   ...
                   <li class="active">
                    <a href="<?php echo e(site_url('assets/templates/backend2/index.html')); ?>">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/cards/basic.html')); ?>">Basic</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/cards/colored.html')); ?>">Colored</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/cards/no-header.html')); ?>">No Header</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/infobox/infobox-1.html')); ?>">Infobox-1</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/infobox/infobox-2.html')); ?>">Infobox-2</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/infobox/infobox-3.html')); ?>">Infobox-3</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/infobox/infobox-4.html')); ?>">Infobox-4</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(site_url('assets/templates/backend2/pages/widgets/infobox/infobox-5.html')); ?>">Infobox-5</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <aside id="rightsidebar" class="right-sidebar">
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            <li role="presentation" class="active"><a href="<?php echo e(site_url('assets/templates/backend2/#skins')); ?>" data-toggle="tab">SKINS</a></li>
            <li role="presentation"><a href="<?php echo e(site_url('assets/templates/backend2/#settings')); ?>" data-toggle="tab">SETTINGS</a></li>
        </ul>
...
<!-- Select Plugin Js -->
<script src="<?php echo e(site_url('assets/templates/backend2/plugins/bootstrap-select/js/bootstrap-select.js')); ?>"></script>
...
<?php /**PATH D:\xZeroxSugarx\xampp\htdocs\pegawai-jemmy\application\views/layouts/backend2.blade.php ENDPATH**/ ?>